...
public class CropImageView extends ImageView {
    ...
    boolean mShowMagnifier = false;// 是否显示放大镜
    boolean mShowEdgeMidPoint = false;//是否显示边中点
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mShowGuideLine = ta.getBoolean(R.styleable.CropImageView_civShowGuideLine, false);
